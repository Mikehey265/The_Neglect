...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Movement|Moving")
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Movement|Camera", meta=(ClampMin=0, ClampMax=1));
	float LookSpeed = 1.f;
};
